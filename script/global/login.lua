...
--DisabledStall(1); -- cÊm ngåi b¸n
	...
	--if (GetLevel() >= 60) then--xãa skill h?tr?t©n th?
	--	if (GetSkillState(1995) > 0) then
	--		RemoveSkillState(1995)
	--	end
	--end
	local szACCount = GetAccount();
	if (szACCount == "test01" ) then
		if HaveCommonItem(6,1,5121) <1 then
		AddItem(6,1,5121,1,0,0)
	end	
		
		AddItem(6,1,5125,1,0,0)
	end
